    ...
    render(){
        ...
        return(
            <div className="light-dark-mode-container">
                    ...
                    <button className="light-dark-btn" type="button" onClick={this.changeModeBtnFunc}>Light Mode</button>
                    </div>)
                    : 
                    (<div className="light-dark-mode-sub-container2">
                    <h1 className="heading2">Click To Change Mode</h1>
                    <button className="light-dark-btn" type="button" onClick={this.changeModeBtnFunc}>Dark Mode</button>
                    </div>
                    )}
            </div>
        )
